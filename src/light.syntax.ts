...
export default [
  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/_base.less
  ...
  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/c.less
  new Rule('source.c keyword.operator', hue3),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/cpp.less
  new Rule('source.cpp keyword.operator', hue3),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/cs.less
  new Rule('source.cs keyword.operator', hue3),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/css.less
  ...
  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/elixir.less
  ...
  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/gfm.less
  new Rule('source.gfm link entity', hue2),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/go.less
  new Rule('source.go storage.type.string', hue3),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/ini.less
  new Rule('source.ini keyword.other.definition.ini', hue5),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/java.less
  ...
  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/javascript.less

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/json.less
  new Rule('source.json support.type.property-name', hue5),
  new Rule('source.json constant.language.json', hue1),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/php.less
  new Rule('source.php class.bracket', mono1),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/python.less
  new Rule('source.python keyword.operator.logical.python', hue3),
  new Rule('source.python variable.parameter', hue6),

  // https://github.com/atom/one-light-syntax/blob/master/styles/syntax/ruby.less
