...
import * as palette from './light.palette'
...
export default {
  ...
  // Text Colors
  // https://github.com/atom/one-light-ui/blob/master/styles/text.less
  ...
  // Button Control
  // https://github.com/atom/one-light-ui/blob/master/styles/buttons.less
  ...
  // Dropdown Control
  // https://github.com/atom/one-light-ui/blob/master/styles/dropdowns.less
  ...
  // Input Control
  // https://github.com/atom/one-light-ui/blob/master/styles/inputs.less
  // https://github.com/atom/one-light-ui/blob/master/styles/editor.less
  ...
  // Scroll Bar Control
  // https://github.com/atom/one-light-ui/blob/master/styles/atom.less#L14
  ...
  // Badge
  // https://github.com/atom/one-light-ui/blob/master/styles/badges.less
  badge_foreground: palette.textColorHighlight,
  badge_background: palette.badgeBackgroundColor,

  // Progress Bar
  // https://github.com/atom/one-light-ui/blob/master/styles/progress.less
  progressBar_background: palette.progressBackgroundColor,

  // Lists and Trees
  // https://github.com/atom/one-light-ui/blob/master/styles/lists.less
  // https://github.com/atom/one-light-ui/blob/master/styles/tree-view.less
  ...
  // Side Bar
  // https://github.com/atom/one-light-ui/blob/master/styles/panels.less
  ...
  // Editor Groups & Tabs
  // https://github.com/atom/one-light-ui/blob/master/styles/tabs.less
  ...
  // Editor Colors
  // https://github.com/atom/one-light-syntax/blob/master/styles/editor.less
  ...
  // https://github.com/atom/one-light-ui/blob/master/styles/modal.less
  ...
  // Status Bar Colors
  // https://github.com/atom/one-light-ui/blob/master/styles/status-bar.less
  ...
  // https://github.com/atom/one-light-ui/blob/master/styles/title-bar.less
  ...
  // Git Colors
  // https://github.com/atom/one-light-ui/blob/master/styles/git.less
